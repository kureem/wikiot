...
public interface JQContants {
	...
	// public final static String DIALOG_DEF_STYLE = "overflow: hidden; display:
	// block; outline-color: -moz-use-text-color; outline-style: none;
	// outline-width: 0px; height: auto;";
	...
	public final static String[] ICONS_BACK_POSITON = new String[] { "-16px 0", "-32px 0", "-48px 0", "-64px 0",
			"-80px 0", "-96px 0", "-112px 0", "-128px 0", "-144px 0", "0 -16px", "-16px -16px", "-32px -16px",
			"-48px -16px", "-64px -16px", "-80px -16px", "-96px -16px", "-112px -16px", "-128px -16px", "-144px -16px",
			"0 -32px", "-16px -32px", "-32px -32px", "-48px -32px", "-64px -32px", "-80px -32px", "-96px -32px",
			"-112px -32px", "-128px -32px", "-144px -32px", "-160px -32px", "-176px -32px", "-192px -32px",
			"-208px -32px", "-224px -32px", "-240px -32px", "0 -48px", "-16px -48px", "-32px -48px", "-48px -48px",
			"-64px -48px", "-80px -48px", "-96px -48px", "-112px -48px", "-128px -48px", "-144px -48px", "-160px -48px",
			"-176px -48px", "-192px -48px", "-208px -48px", "-224px -48px", "-240px -48px", "0 -64px", "-16px -64px",
			"-32px -64px", "-48px -64px", "-64px -64px", "-80px -64px", "-96px -64px", "-112px -64px", "-128px -64px",
			"-144px -64px", "-160px -64px", "-176px -64px", "0 -80px", "-16px -80px", "-32px -80px", "-48px -80px",
			"-64px -80px", "-80px -80px", "-96px -80px", "-112px -80px", "0 -96px", "-16px -96px", "-32px -96px",
			"-48px -96px", "-64px -96px", "-80px -96px", "-96px -96px", "-112px -96px", "-128px -96px", "-144px -96px",
			"-160px -96px", "-176px -96px", "-192px -96px", "-208px -96px", "-224px -96px", "-240px -96px", "0 -112px",
			"-16px -112px", "-32px -112px", "-48px -112px", "-64px -112px", "-80px -112px", "-96px -112px",
			"-112px -112px", "-128px -112px", "-144px -112px", "-160px -112px", "-176px -112px", "-192px -112px",
			"-208px -112px", "-224px -112px", "-240px -112px", "0 -128px", "-16px -128px", "-32px -128px",
			"-48px -128px", "-64px -128px", "-80px -128px", "-96px -128px", "-112px -128px", "-128px -128px",
			"-144px -128px", "-160px -128px", "-176px -128px", "-192px -128px", "-208px -128px", "-224px -128px",
			"-240px -128px", "0 -144px", "-16px -144px", "-32px -144px", "-48px -144px", "-64px -144px", "-80px -144px",
			"-96px -144px", "-112px -144px", "-128px -144px", "-144px -144px", "0 -160px", "-16px -160px",
			"-32px -160px", "-48px -160px", "-64px -160px", "-80px -160px", "-96px -160px", "-112px -160px",
			"-128px -160px", "-144px -160px", "0 -176px", "-16px -176px", "-32px -176px", "-48px -176px",
			"-64px -176px", "-80px -176px", "-96px -176px", "0 -192px", "-16px -192px", "-32px -192px", "-48px -192px",
			"-64px -192px", "-80px -192px", "-96px -192px", "-112px -192px", "-128px -192px", "-144px -192px",
			"-160px -192px", "-176px -192px", "-192px -192px", "-208px -192px", "0 -208px", "-16px -208px",
			"-32px -208px", "-48px -208px", "-64px -208px", "-80px -208px", "0 -224px", "-16px -224px", "-32px -224px",
			"-48px -224px", "-64px -224px", "-80px -224px"
			...
			for (Container tab : panelTabs.getChildren()) {
				...
				if (index.equals(oTab)) {
					...
					if ("false".equalsIgnoreCase(isInitialised)) {
						Container rContent = panel.getModel().getTabContentAt(panel, Integer.parseInt(index));
						content.addChild(rContent);
						// ((EXTabPanel)panel).getTabRenderer().onActivateContent(panel,
						// model, Integer.parseInt(oTab), rContent);
						// on init goes here
					}
	...
	public final static Event CLOSE_EVENT = new Event() {
		...
		public void ClientAction(JQuery container) {
			container.getAncestorOfType(Panel.class).fadeOut(100, container.clone().server(this));

		}

		public boolean ServerAction(Container container, Map<String, String> request) throws UIException {
			container.getAncestorOfType(org.castafiore.ui.ex.panel.Panel.class).remove();
			return true;
		}
