...
import org.castafiore.ui.ex.inputs.EXInput;
 ...
 * Oct 22, 2008
 */
public class EXDropdown<T>  extends EXContainer implements Event, FormInput<T>{
	...
	//	container.server(this);
		container.IF(container.getAttribute("init").equal(new JSVar("true")), container.clone(), container.clone().setTimeout(container.clone().server(this), 1));
